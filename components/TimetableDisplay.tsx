...
import { TimetableEntry, Program, Faculty, Room } from '../types';
...
const TimetableDisplay: React.FC<TimetableDisplayProps> = ({ timetable, programs, faculty, rooms }) => {
  ...
  if (!timetable || timetable.length === 0) {
    return (
      <div className="mt-8 text-center p-12 bg-white rounded-xl shadow-md border border-gray-200">
        ...
        <p className="text-gray-500 mt-2">Add your data and click "Generate Timetable" to see the magic happen!</p>
  ...
  return (
    <div className="mt-8 bg-white p-6 rounded-xl shadow-lg border border-gray-200">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <h2 className="text-3xl font-bold text-gray-800 mb-4 sm:mb-0">Generated Timetable</h2>
            {renderFilters()}
        </div>
